        ...
        <Card.Content>
            <Content>
                <Column.Group>
                    <Column size={3}>
                        <figure class="image is-128x128">
                            <a href="https://www.makeyourchange.org/" target="_blank" rel="noopener noreferrer" >
                                <img
                                    alt="Make_Your_Change-logo"
                                    src={MYC_logo}
                                />
                            </a>
                        </figure>
                ...
                <Column.Group>
                    <Column size={3}>
                        <figure class="image is-128x128">
                            <a href="https://www.aec.com.br/" target="_blank" rel="noopener noreferrer" >
                                <img
                                    alt="AEC-logo"
                                    src={AEC_Logo}
                                />
